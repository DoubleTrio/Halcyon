...
function metano_town_ch_5.SetupGround()
	...
	if SV.Chapter5.SawZigzagoonFamilyCutscene then
		...
		AI:SetCharacterAI(growlithe, "ai.ground_default", RogueElements.Loc(1200, 900), RogueElements.Loc(32, 32), 1, 16, 32, 40, 180)
	end
	...
	AI:SetCharacterAI(luxray, "ai.ground_default", RogueElements.Loc(luxray.Position.X-16, luxray.Position.Y-16), RogueElements.Loc(32, 32), 1, 16, 32, 40, 180)
	AI:SetCharacterAI(machamp, "ai.ground_default", RogueElements.Loc(machamp.Position.X-16, machamp.Position.Y-16), RogueElements.Loc(32, 32), 1, 16, 32, 40, 180)
